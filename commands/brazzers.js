...
exports.run = async (client, message, args) => {
    ...
    get(`https://eclyssia-api.tk/api/v1/brazzers?url=${member.user.displayAvatarURL}`, {  responseType: 'arraybuffer'})
        .then((response) => {
            message.channel.send("<:browser1:600349429597470740> Image **brazzers** générée par **eclyssia-api.tk**:",{
                file: {
...
exports.conf = {
  ...
  exports.help = {
    name: "brazzers",
    category: "Images",
    description: "Affiche une image de type\"brazzers\"",
    usage: "brazzers"
  };
