...
exports.run = async (client, message, args) => {
    ...
    message.channel.send("<:picture:605752181173256202> Génération de l'image...").then(msg => {
        get(`https://eclyssia-api.tk/api/v1/pixelate?url=${profilepic}`, {
            responseType: "arraybuffer"
        })
        .then(res =>
            message.channel.send("<:picture:605752181173256202> Image **pixelate** générée par **eclyssia-api.tk**:",{
...
exports.conf = {
  ...
  exports.help = {
    name: "pixelate",
    category: "Images",
    description: "Affiche une image de type\"pixelate\"",
    usage: "pixelate"
  };
