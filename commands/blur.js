...
exports.run = async (client, message, args) => {
    ...
    get(`https://eclyssia-api.tk/api/v1/blur?url=${member.user.displayAvatarURL}`, {  responseType: 'arraybuffer'})
        .then((response) => {
            message.channel.send("<:browser1:600349429597470740> Image **blur** générée par **eclyssia-api.tk**:",{
                file: {
...
exports.conf = {
  ...
  exports.help = {
    name: "blur",
    category: "Images",
    description: "Affiche une image de type\"blur\"",
    usage: "blur"
  };
